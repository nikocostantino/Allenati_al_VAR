...
public class DBManager {
	...
	private DBManager() {
		...
		aggiungiVideo(new Video("https://www.youtube.com/embed/5TKseKToQ6c","Stopping Promise Attack","Questa è la descrizione","DIFFICILE",new Categoria("recenti"),new OpzioniRisposte("corretta", "errata")));
